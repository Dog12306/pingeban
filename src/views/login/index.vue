  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="check-login">
        <span :class="{active : checklogin}" @click="zhLogin">账号登录</span>
        <span :class="{active : !checklogin}" @click="smLogin">扫码登录</span>
      </div>
      <div v-show="checklogin">
        ...
        <el-form-item prop="yan">
          ...
          <el-input
            ...
            class="yan-input"
          />
          <img :src="imgCode" alt class="yan-img" @click="getImg" />
        </el-form-item>
        <el-button
          :loading="loading"
          type="primary"
